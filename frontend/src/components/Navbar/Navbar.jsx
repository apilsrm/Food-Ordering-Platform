  ...
  return (
    <div className="flex justify-between items-center px-0 py-5">
      ...
      <div className="flex items-center gap-10">
        ...
        <button
        className="bg-transparent text-base text-[#49557e] cursor-pointer px-[30px] py-2.5 rounded-[50px] border border-solid border-[tomato] transition duration-300 hover:bg-[#fff4f9]"
